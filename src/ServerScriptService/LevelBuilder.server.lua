--[[
    ChronoRush - Level Initializer
    Server script that builds the obstacle course map
    This creates all the visible parts in the game world
]]

local Workspace = game:GetService("Workspace")

-- Create ChronoRush folder in workspace if not exists
local ChronoRush = Workspace:FindFirstChild("ChronoRush")
if not ChronoRush then
    ChronoRush = Instance.new("Folder")
    ChronoRush.Name = "ChronoRush"
    ChronoRush.Parent = Workspace
end

print("ChronoRush workspace folder ready")

-- Build Level 1 Obstacle Course
local function BuildLevel1()
    print("Building Level 1 obstacle course...")
    
    -- Clear existing
    local existingCourse = ChronoRush:FindFirstChild("ObstacleCourse")
    ...
    courseFolder.Parent = ChronoRush
    ...
    lavaFloor.Parent = courseFolder
    
    -- Death script on lava
    ...
    checkpoint.Parent = courseFolder
    ...
    finishLine.Parent = courseFolder
    ...
    print("Level 1 built!")
    print("- GREEN platforms to jump")
    print("- RED lava (touch = death)")
    print("- YELLOW arrows guide you")
    print("- CYAN checkpoint")
    print("- GOLD finish line")
end

-- Run when game starts
BuildLevel1()

-- Create spawn location marker
local spawnPoint = Instance.new("SpawnLocation")
spawnPoint.Name = "PlayerSpawn"
spawnPoint.Size = Vector3.new(10, 1, 10)
spawnPoint.Position = Vector3.new(0, 0.5, -5)
spawnPoint.Anchored = true
spawnPoint.Material = Enum.Material.SmoothPlastic
spawnPoint.Color = Color3.fromRGB(50, 50, 60)
spawnPoint.Parent = ChronoRush

print("Game map is ready!")